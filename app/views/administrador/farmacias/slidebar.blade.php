<div class="block col-lg-offset-1">
	...
	<ul>
		...
		<li><a href="{{route('farmacia.create')}}">Crear farmacia</a></li>
		<li><a href="{{route('farmacia.index')}}">Listar farmacias</a></li>		
		<li><a href="{{URL::to('reportefarmacia')}}">Reportes de farmacia por zonas</a></li>
		<li><a href="{{URL::to('reportefarmaciasgeneral')}}">Reporte de farmacias en general</a></li>	
